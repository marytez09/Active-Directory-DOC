...
- Create OUs within the domain for different departments
    ...
    - Europe
    - Asia
- Create user accounts and groups within the OUs
    - Added groups: Users, Computers, Servers
    - Added departments for each group: IT, and HR
    - Added user accounts for each department
